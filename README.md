...
**CVM was an experiment and is no longer into active development. You can browse code and pick any ideas you want, or give a try to other attempts : [biicode](http://www.biicode.com/), [cpm](https://github.com/iauns/cpm), [pacm](http://sourcey.com/pacm/), [insert _google "C++ package manager"_ here]...**
